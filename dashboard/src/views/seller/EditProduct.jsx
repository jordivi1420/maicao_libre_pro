                    ...
                    <form onSubmit={update}>
                        ...
                        <div className='flex flex-col mb-3 md:flex-row gap-4 w-full text-[#d0d2d6]'>
                            ...
                            <div className='flex flex-col w-full gap-1'>
                                ...
                                <input className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]' onChange={inputHandle} value={state.discount} type="number" placeholder='%Descuento%' name='discount' id='discount' />
                            </div>
                        </div>
                        ...
                        <div className='flex'>
                            <button disabled={loader ? true : false} className='bg-blue-500 w-[190px] hover:shadow-blue-500/20 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>
                                {
                                    loader ? <PropagateLoader color='#fff' cssOverride={overrideStyle} /> : 'Actualizar producto'
                                }
                            </button>
                        </div>
                    </form>
