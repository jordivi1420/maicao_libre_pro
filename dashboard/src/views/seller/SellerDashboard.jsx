            ...
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7'>
                <div className='flex justify-between items-center p-5 bg-[#283046] rounded-md gap-3'>
                    <div className='flex flex-col justify-start items-start text-[#d0d2d6]'>
                        ...
                        <span className='text-md font-medium'>Venta total</span>
                    </div>
                ...
                <div className='w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0'>
                    <div className='w-full bg-[#283046] p-4 rounded-md text-[#d0d2d6]'>
                        <div className='flex justify-between items-center'>
                            <h2 className='font-semibold text-lg text-[#d0d2d6] pb-3'>Mensajes recientes con los clientes</h2>
                ...
                <div className='relative overflow-x-auto'>
                    <table className='w-full text-sm text-left text-[#d0d2d6]'>
                        <thead className='text-sm text-[#d0d2d6] uppercase border-b border-slate-700'>
                            <tr>
                                <th scope='col' className='py-3 px-4'>Id de la orden</th>
                                <th scope='col' className='py-3 px-4'>Precio</th>
                                <th scope='col' className='py-3 px-4'>Estado del pago </th>
                        ...
                        <tbody>
                            {
                                recentOrders.map((d, i) => <tr key={i}>
                                    ...
                                    <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>
                                        <span>{traducirEstadoOrden( d.delivery_status)}</span>
                                    </td>
                                    <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>
                                        <span>{traducirEstadoPago(d.payment_status)}</span>
                                    </td>
                                    <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>
                                        <Link to={`/seller/dashboard/order/details/${d._id}`}>Ver</Link>
                                    </td>
                                </tr>)
                            }
                        </tbody>
