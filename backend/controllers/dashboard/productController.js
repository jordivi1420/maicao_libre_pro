        ...
        form.parse(req, async (err, field, files) => {
            ...
            try {
                let allImageUrl = [];
                         ...
                         // Buscar la imagen del vendedor
                         const seller = await sellerModel.findById(id).select('image name');
                        const sellerImage = seller ? seller.image : '';
                ...
                await productModel.create({
                    sellerId: id,
                    sellerImage: sellerImage, // Incluye la imagen del vendedor en el producto
